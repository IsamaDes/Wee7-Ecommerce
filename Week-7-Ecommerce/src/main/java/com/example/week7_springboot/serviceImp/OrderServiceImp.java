...
import com.example.week7_springboot.repositories.OrderRepositories;
...
public class OrderServiceImp {
    ...
    @Autowired
    public OrderServiceImp(OrderRepositories orderRepositories, UsersServiceImp usersService) {
